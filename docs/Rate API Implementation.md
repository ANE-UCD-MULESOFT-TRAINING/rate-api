...
![image](https://github.com/ANE-UCD-MULESOFT-TRAINING/rate-api/blob/implementation/docs/Images/2.1.png)

Right clink on the project explorer pane, and select mule project.

![image](https://github.com/ANE-UCD-MULESOFT-TRAINING/rate-api/blob/implementation/docs/Images/2.2.png)

The following window opens

![image](https://github.com/ANE-UCD-MULESOFT-TRAINING/rate-api/blob/implementation/docs/Images/2.3.png)

 - Project Name - **rate-api**
 - Runtime - **Mule Server 4.3.0**
 - We can uncheck the **Use default location** checkbox and choose to save the project anywhere on the disk.
 - Select the tab - **Download RAML from Design Center**
...
![image](https://github.com/ANE-UCD-MULESOFT-TRAINING/rate-api/blob/implementation/docs/Images/2.4.png)

Anypoint studio will fetch the API Spec from exchange and we should see the below window on successful fetch.

![image](https://github.com/ANE-UCD-MULESOFT-TRAINING/rate-api/blob/implementation/docs/Images/2.5.png)
...
![image](https://github.com/ANE-UCD-MULESOFT-TRAINING/rate-api/blob/implementation/docs/Images/2.6.png)
...
![image](https://github.com/ANE-UCD-MULESOFT-TRAINING/rate-api/blob/implementation/docs/Images/2.7.png)
...
![image](https://github.com/ANE-UCD-MULESOFT-TRAINING/rate-api/blob/implementation/docs/Images/2.8.png)
...
We can also remove the first transform message connector which is redundant for this flow. Add the logging message to the logger connector as shown below.
 ...
 ![image](https://github.com/ANE-UCD-MULESOFT-TRAINING/rate-api/blob/implementation/docs/Images/2.9.png)
...
Mongo Module and connectors are not found in the mule palette by default. When we search for mongo in mule palette, no results will be returned.
 ...
 ![image](https://github.com/ANE-UCD-MULESOFT-TRAINING/rate-api/blob/implementation/docs/Images/2.10.png)



In order to add it, we need to fetch it from exchange. In Mule Palette, click  
**Search in Exchange**

![image](https://github.com/ANE-UCD-MULESOFT-TRAINING/rate-api/blob/implementation/docs/Images/2.11.png)


Search for mongo and add the MongoDB Connector Module for Mule 4. Click Finish.

 ![image](https://github.com/ANE-UCD-MULESOFT-TRAINING/rate-api/blob/implementation/docs/Images/2.12.png)


![image](https://github.com/ANE-UCD-MULESOFT-TRAINING/rate-api/blob/implementation/docs/Images/2.13.png)

Now we should be able to see the MongoDB module in Mule Palette. 

![image](https://github.com/ANE-UCD-MULESOFT-TRAINING/rate-api/blob/implementation/docs/Images/2.14.png)

Drag and Drop **Find documents** connector.

![image](https://github.com/ANE-UCD-MULESOFT-TRAINING/rate-api/blob/implementation/docs/Images/2.15.png)
...
We need to configure the **Find documents** connector by adding necessary attributes to the connector properties. We will configure the below.
 ...
 - Connector Configuration - Mongo connection attributes
 - Query to execute against mongo
 - Collection name
 - Fields 
...
![image](https://github.com/ANE-UCD-MULESOFT-TRAINING/rate-api/blob/implementation/docs/Images/2.16.png)


Also, add MongoDB driver as shown above. Confirm adding the library by clicking OK. 

![image](https://github.com/ANE-UCD-MULESOFT-TRAINING/rate-api/blob/implementation/docs/Images/2.17.png)
...
![image](https://github.com/ANE-UCD-MULESOFT-TRAINING/rate-api/blob/implementation/docs/Images/2.18.png)
...
![image](https://github.com/ANE-UCD-MULESOFT-TRAINING/rate-api/blob/implementation/docs/Images/2.19.png)
...
![image](https://github.com/ANE-UCD-MULESOFT-TRAINING/rate-api/blob/implementation/docs/Images/2.20.png)
...
![image](https://github.com/ANE-UCD-MULESOFT-TRAINING/rate-api/blob/implementation/docs/Images/2.21.png)
...
![image](https://github.com/ANE-UCD-MULESOFT-TRAINING/rate-api/blob/implementation/docs/Images/2.22.png)

Once the variable is created, we will refer this variable in the Transform message connector to be returned as the output.

![image](https://github.com/ANE-UCD-MULESOFT-TRAINING/rate-api/blob/implementation/docs/Images/2.23.png)
...
![image](https://github.com/ANE-UCD-MULESOFT-TRAINING/rate-api/blob/implementation/docs/Images/2.24.png)
...
![image](https://github.com/ANE-UCD-MULESOFT-TRAINING/rate-api/blob/implementation/docs/Images/2.25.png)

The console will show the message that we have configured in the logger connector.

![image](https://github.com/ANE-UCD-MULESOFT-TRAINING/rate-api/blob/implementation/docs/Images/2.26.png)

We have successfully created a get flow which is working as expected.

Follow the same pattern and create a Post and Delete flow using the appropriate connectors from the mongo connector documentation link [here](https://docs.mulesoft.com/mongodb-connector/6.3/mongodb-connector-reference)
